...
public class ObjectRecognizer {
	...
	public static void main(String[] args) {
		try {
			final BufferedImage part = ImageIO.read(ObjectRecognizer.class.getResourceAsStream("/res/screenshot.png"));
			final BufferedImage image = ImageIO.read(ObjectRecognizer.class.getResourceAsStream("/res/maxresdefault.png"));
			
			findSubimage(part, image);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
